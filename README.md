...
[![Software DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22134734.svg)](https://doi.org/10.5281/zenodo.22134734)
...
**To cite the research**, please cite the peer-reviewed article:
...
@software{irshad2026uncertainty_code,
  ...
  version   = {v1.0.0},
  publisher = {Zenodo},
  doi       = {10.5281/zenodo.22134734},
  url       = {https://doi.org/10.5281/zenodo.22134734}
}
```

The Zenodo DOI [`10.5281/zenodo.22134734`](https://doi.org/10.5281/zenodo.22134734)
is the *concept* DOI and always resolves to the latest archived version
(v1.0.0 is [`10.5281/zenodo.22134735`](https://doi.org/10.5281/zenodo.22134735)).
